...
4. Перекладаючи ім'я персонажа з японської на українську спочатку вказується прізвище, а потім ім'я. Виключенням є персонажі з європейськими, слов'янськими та американськими іменами. В такому разі спочатку вказується ім'я, а потім прізвище. Також в окремих випадках можуть розглядатися імена, які не мають конкретного походження. Такі імена були представлені автором або їх потрібно розглядати спільнотою
